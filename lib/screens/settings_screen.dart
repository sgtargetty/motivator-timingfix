// lib/screens/settings_screen.dart - CLEANED UP VERSION
...
class _SettingsScreenState extends State<SettingsScreen>
  ...
  bool _smartReflectionEnabled = true;
  ...
  Future<void> _loadUserSettings() async {
    ...
    setState(() {
      ...
      _smartReflectionEnabled = prefs.getBool('smart_reflection_enabled') ?? true;
  ...
  // 🎭 Beautiful AI Companion Section
          ...
          GestureDetector(
            onTap: () {
              Navigator.pushAndRemoveUntil(
                context,
                MaterialPageRoute(
                  builder: (context) => MemoryManagementScreen(selectedPersona: _selectedPersona),
                ),
                (route) => false,
              );
            },
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        const SizedBox(height: 4),
                        Text(
                          'View conversations, manage memories, track relationships',
                          style: TextStyle(
                            color: const Color(0xFF8B9DC3).withOpacity(0.8),
                            fontSize: 12,
                          ),
